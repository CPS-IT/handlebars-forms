...
/**
 * MultiCheckboxViewModelBuilderTest
 *
 * @author Elias Häußler <e.haeussler@familie-redlich.de>
 * @license GPL-2.0-or-later
 */
#[Framework\Attributes\CoversClass(Src\Domain\ViewModel\Builder\MultiCheckboxViewModelBuilder::class)]
final class MultiCheckboxViewModelBuilderTest extends ViewModelBuilderTestCase
{
    private Src\Domain\ViewModel\Builder\MultiCheckboxViewModelBuilder $subject;
    ...
    public function setUp(): void
    {
        ...
        $this->subject = new Src\Domain\ViewModel\Builder\MultiCheckboxViewModelBuilder(
            $this->get(Src\Fluid\ViewHelperInvoker::class),
        );
    }

    #[Framework\Attributes\Test]
    public function supportsReturnsTrueForMultiCheckbox(): void
    {
