...
/**
 * FieldsetViewModelBuilder
 *
 * @author Elias Häußler <e.haeussler@familie-redlich.de>
 * @license GPL-2.0-or-later
 *
 * @extends AbstractViewModelBuilder<Form\Domain\Model\FormElements\Section>
 */
final class FieldsetViewModelBuilder extends AbstractViewModelBuilder
{
    ...
    public function renderRenderable(
        ...
        $tag = new FluidStandalone\Core\ViewHelper\TagBuilder('fieldset');
