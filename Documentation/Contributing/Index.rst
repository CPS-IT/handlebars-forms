...
..  image:: https://img.shields.io/coverallsCoverage/github/CPS-IT/handlebars-forms?logo=coveralls
    :target: https://coveralls.io/github/CPS-IT/handlebars-forms

..  image:: https://img.shields.io/github/actions/workflow/status/CPS-IT/handlebars-forms/cgl.yaml?label=CGL&logo=github
    :target: https://github.com/CPS-IT/handlebars-forms/actions/workflows/cgl.yaml

..  image:: https://img.shields.io/github/actions/workflow/status/CPS-IT/handlebars-forms/tests.yaml?label=Tests&logo=github
    :target: https://github.com/CPS-IT/handlebars-forms/actions/workflows/tests.yaml
...
`submit a pull request <https://github.com/CPS-IT/handlebars-forms/compare>`__
